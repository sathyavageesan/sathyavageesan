...
public class YourLogoforTestNGAlphabeticalOrder {
	WebDriver driver;
	...
	//Registration
    @Test
    public void b_initialRegistration( ) throws InterruptedException {
	driver.findElement(By.xpath("//a[@class='login']")).click();
	driver.findElement(By.id("email_create")).sendKeys("Dec10th000@yopmail.com");
	Thread.sleep(2000);
	...
	driver.findElement(By.id("email")).sendKeys("Dec10th000@yopmail.com");
	driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
